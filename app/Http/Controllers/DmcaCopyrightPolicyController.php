    ...
    public function index()
    {
        $dmcaPolicy = [
            ...
            'intro' => [
                ...
                'Eagles Repair operates as a technology information and product discovery platform and is committed to responding appropriately to valid copyright concerns in accordance with applicable intellectual property laws.',
            ...
            'sections' => [
                [
                    ...
                    'note' => 'Eagles Repair respects these rights and takes copyright concerns seriously.',
                ],
                [
                ...
                [
                    ...
                    'body' => [
                        ...
                        'Upon receipt of a valid notice, Eagles Repair may:',
                    ],
                ...
                [
                    ...
                    'note' => 'Eagles Repair may review counter-notifications and take action as appropriate under applicable law.',
                ],
                [
                    'title' => 'Repeat Infringer Policy',
                    'body' => ['Eagles Repair reserves the right to take appropriate action against users who repeatedly infringe intellectual property rights.', 'Actions may include:'],
                    'items' => ['Restricting Website Access', 'Removing Content', 'Suspending User Privileges', 'Terminating Access To Website Services'],
                    'note' => 'The determination of repeat infringement shall be made at Eagles Repair\'s sole discretion.',
                ],
                [
                    ...
                    'note' => 'Eagles Repair reserves the right to reject notices that appear abusive, incomplete, or submitted in bad faith.',
                ],
                [
                    'title' => 'Third-Party Content',
                    'body' => [
                        'The website may contain information, content, or materials obtained from third-party sources.',
                        'Eagles Repair does not claim ownership of third-party copyrighted materials unless expressly stated.',
                ...
                [
                    ...
                    'note' => 'Nothing in this Policy creates an obligation to monitor all content on the website continuously.',
                ],
                [
                    'title' => 'Reservation Of Rights',
                    'body' => ['Eagles Repair reserves the right to:'],
                ...
                [
                    ...
                    'body' => [
                        'Eagles Repair reserves the right to update, modify, or replace this DMCA Copyright Policy at any time.',

...
class ProductInformationDisclaimerController extends Controller
{
    public function index()
    {
        $productDisclaimer = [
            ...
            'date' => 'June 2026',
            'intro' => [
                'This Product Information Disclaimer explains the limitations, conditions, and intended use of the product-related information presented on the Eagles Repair website.',
                'Eagles Repair operates as a technology, information, and product discovery platform. The website provides information regarding printers, scanners, desktops, thin clients, and other technology-related products for informational and reference purposes.',
            ...
            'sections' => [
                ...
                [
                    ...
                    'note' => 'Eagles Repair does not guarantee that products will perform in a particular manner or achieve specific results.',
                ],
                [
                    'title' => 'Product Documentation',
                    'body' => ['The website may reference manuals, guides, specifications, technical documents, and other informational materials.', 'Such references are provided solely for informational convenience.', 'Eagles Repair does not warrant:'],
                ...
                [
                    ...
                    'body' => ['Certain product information may originate from third-party sources, manufacturers, suppliers, or publicly available materials.', 'Eagles Repair does not guarantee:'],
                ...
                [
                    ...
                    'body' => ['All product information is provided on an "as is" and "as available" basis.', 'Eagles Repair makes no representations or warranties regarding:'],
                ...
                [
                    ...
                    'body' => ['To the fullest extent permitted by applicable law, Eagles Repair shall not be liable for any losses, damages, costs, or consequences arising from:'],
                ...
                [
                    ...
                    'body' => [
                        ...
                        'Eagles Repair is under no obligation to update previously published information immediately following manufacturer or supplier changes.',
                ...
                [
                    ...
                    'body' => ['By accessing, browsing, or using the website, submitting enquiries, or relying upon product-related information, you acknowledge that you have read, understood, and agreed to the terms outlined in this Product Information Disclaimer.'],
                ],
            ],
        ];

...
class TermsConditionsController extends Controller
{
    public function index()
    {
        $terms = [
            ...
            'date' => 'June, 2026',
            'intro' => [
                'Welcome to Eagles Repair. These Terms and Conditions govern your access to and use of our website, content, services, quote request forms, and related resources.',
                ...
                'Eagles Repair operates as a technology, information, and product discovery platform. The website provides information regarding printers, scanners, desktops, thin clients, and related technology products. The website may also provide users with the ability to submit enquiries and request product-related information.',
            ],
            'sections' => [
                [
                    ...
                    'items' => [
                        ...
                        'Allows users to submit quote requests and enquiries.',
                ...
                [
                    ...
                    'body' => ['By using the website, you represent and warrant that:'],
                    'items' => [
                ...
                [
                    ...
                    'body' => ['Users may submit quote requests, information requests, or product enquiries through the website.', 'Submission of a quote request:'],
                    'items' => [
                    ...
                    'note' => 'Eagles Repair reserves the right to respond, decline, or not respond to enquiries at its discretion.',
                ],
                [
                ...
                [
                    ...
                    'note' => 'Violation of these Terms may result in restricted access or other actions deemed appropriate.',
                ],
                [
                ...
                [
                    ...
                    'body' => ['The website may contain links to third-party websites for convenience or informational purposes.', 'Eagles Repair does not control and is not responsible for:'],
                    'items' => ['Third-party content.', 'Privacy practices.', 'Security measures.', 'Website functionality.', 'Information accuracy.'],
                    'note' => 'Users access third-party websites at their own discretion and risk.',
                ],
                [
                    'title' => 'Disclaimer Of Warranties',
                    'body' => ['The website and its content are provided on an "as is" and "as available" basis.', 'Eagles Repair makes no representations or warranties regarding:'],
                    'items' => ['Information accuracy.', 'Website availability.', 'Website performance.', 'Content completeness.', 'Product suitability.', 'Error-free operation.', 'Continuous accessibility.'],
                ...
                [
                    ...
                    'body' => [
                        'Eagles Repair reserves the right to modify, update, or replace these Terms and Conditions at any time without prior notice.',
                ...
                [
                    'title' => 'Governing Law',
                    'body' => ['These Terms and Conditions shall be governed and interpreted in accordance with the applicable laws of the jurisdiction in which Eagles Repair operates, without regard to conflict of law principles.'],
                ],
                [
                ...
                [
                    ...
                    'body' => ['By accessing, browsing, or using this website, submitting enquiries, or interacting with the platform, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.'],
                ],
            ],
        ];

            ...
            <div class="printer-category-grid">
                ...
                @foreach ($printerCategories as $category)
                    @php
                        ...
                        $categoryImage = collect($categoryImageCandidates)->first(
                            fn($image) => file_exists(public_path('assets/images/product/' . $image)),
                        );
                    ...
                    <div class="printer-category-item">
                        <div
                            ...
                            <div class="product-img product-img-zoom mb-20">
                                <a href="{{ $categoryUrl }}">
                                    <img src="{{ asset('assets/images/product/' . $categoryImage) }}"
                                        alt="{{ $category->name }}">
                                </a>
                            </div>
    ...
    <div class="product-area printer-products-area pb-80">
        <div class="container">
            <div class="section-title-2 text-center mb-45">
                ...
                <p>{{ $isAllProductsPage ? ($productType ? 'Latest ' . $typeName . ' Collection' : 'All Product Collection') : 'Latest ' . $typeName . ' Collection' }}
                </p>
            </div>
